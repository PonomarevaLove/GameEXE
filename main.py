...
class MyGame(arcade.Window):
   ...
   def setup(self):
       ...
       self.score = 0
       self.player_sprite = arcade.Sprite("plate.png", SPRITE_SCALING_PLAYER/5)
   ...
   def on_draw(self):
       ...
       if self.game_state == GAME_OVER:
           arcade.draw_text("GAME OVER", 250, 300, arcade.color.BLACK, 55)
   ...
   def allow_enemies_to_fire(self):
       ...
       for enemy in self.enemy_list:
           ...
           if random.randrange(chance) == 0 and enemy.center_x not in x_spawn:
               bullet = arcade.Sprite("og5.png", SPRITE_SCALING_LASER/25)
               bullet.angle = 180
               bullet.change_y = -BULLET_SPEED
